    ...
    def getWmsErp(self):
        try:
            ...
            cursor.execute("SELECT "+
                            ...
                            "FROM [SCALEINT].[dbo].[INVENTARIO] (NOLOCK) "+
    ...
    def getItems(self):
        try:
            ...
            cursor.execute("SELECT "+ 
                            ...
                            ", (SELECT COUNT (XX.[ITEM]) FROM [SCALEINT].[dbo].[INVENTARIO] XX (NOLOCK) WHERE CONVERT(DATE, XX.FECHA) = CONVERT(DATE,GETDATE()-1) "+
                            "AND XX.[ERP_ALMACEN] = YY.[ERP_ALMACEN] AND (XX.ERP_DISPONIBLE) != 0) AS '#ITEMS' "+
                            "FROM [SCALEINT].[dbo].[INVENTARIO] YY (NOLOCK) "+
