...
class HuellaDigitalSerializer(serializers.Serializer):
    ...
    uomEntry = serializers.CharField()  
    height1 = serializers.CharField()  
    width1 = serializers.CharField()  
    length1 = serializers.CharField()  
    volume = serializers.CharField()  
    ugpCode = serializers.CharField()  
    weight1 = serializers.CharField()  
